...
export default function SinglyLinkedListOperationsClient() {
    ...
    return (
        <details
            ...
            open={
                detailsState["singlyLinkedListOp"] !== undefined
                    ? detailsState["singlyLinkedListOp"]
                    : true
            }
        >
                                ...
                                {list.map((item, index) => (
                                    ...
                                    >
                                        <div
                                            ...
                                            className="cell flex h-8 w-10 sm:h-11 sm:w-14 shrink-0 items-center justify-center rounded-l-md border border-border bg-element text-ink font-semibold text-xs sm:text-base"
                                        >
                                            {item}
                                        </div>
                                        ...
                                        <span className="mx-1 sm:mx-2 font-medium text-muted text-[10px] sm:text-base">
                                            ──➤
                                        </span>
                                        {index === list.length - 1 && (
                                            <span className="font-medium text-muted text-[10px] sm:text-base">
                                                NULL
                                            </span>
                                        )}
                                    </div>
