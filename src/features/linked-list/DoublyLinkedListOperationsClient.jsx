...
export default function DoublyLinkedListOperationsClient() {
    ...
    async function insertInList() {
        ...
        if (
            customIdx === "" ||
            parseInt(customIdx) < 0 ||
            parseInt(customIdx) > list.length
        ) {
    ...
    return (
        <details
            ...
            open={
                detailsState["doublyLinkedListOp"] !== undefined
                    ? detailsState["doublyLinkedListOp"]
                    : true
            }
        >
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            <div className="flex w-full rounded-md border border-borderStrong bg-surface p-1 sm:w-fit">
                                <button
                                    ...
                                    disabled={isBusy}
                                    className={`flex-1 rounded px-3 py-1.5 text-xs font-medium transition-colors sm:flex-none ${insertMode === "end"
                                            ? "bg-accent text-white"
                                            : "text-muted hover:bg-element hover:text-ink"
                                        }`}
                                >
                                ...
                                <button
                                    ...
                                    disabled={isBusy}
                                    className={`flex-1 rounded px-3 py-1.5 text-xs font-medium transition-colors sm:flex-none ${insertMode === "index"
                                            ? "bg-accent text-white"
                                            : "text-muted hover:bg-element hover:text-ink"
                                        }`}
                                >
                            ...
                            <div className="flex w-full flex-wrap rounded-md border border-borderStrong bg-surface p-1 sm:w-fit sm:flex-nowrap">
                                {[
                                    ...
                                    <button
                                        ...
                                        disabled={isBusy}
                                        className={`flex-1 basis-1/3 rounded px-3 py-1.5 text-xs font-medium transition-colors sm:basis-0 sm:flex-none ${deleteMode === mode.id
                                                ? "bg-accent text-white"
                                                : "text-muted hover:bg-element hover:text-ink"
                                            }`}
                                    >
                            ...
                            <div className="flex flex-wrap items-center gap-y-4 p-1">
                                {list.map((node, index) => (
                                    <React.Fragment key={node.id}>
                                        ...
                                        {index === 0 && (
                                            <>
                                                <span className="mr-1 font-medium text-muted text-[10px] sm:text-base">
                                                    NULL
                                                </span>
                                        ...
                                        {/* Node */}
                                        <div
                                            className={`cell flex h-8 w-10 sm:h-11 sm:w-14 shrink-0 items-center justify-center rounded-md border border-border bg-element text-ink font-semibold transition-all duration-300 text-xs sm:text-base
                        ${node.id === enteringId ? "animate-fade-in" : ""}
                        ${node.id === leavingId
                                                    ? "!scale-75 !opacity-0 !border-swapping"
                                                    : ""
                                                }`}
                                            id={`node-${node.id}`}
                                        ...
                                        {index === list.length - 1 && (
                                            <>
                                                ...
                                                <span className="ml-1 font-medium text-muted text-[10px] sm:text-base">
                                                    NULL
                                                </span>
                                            </>
                                        )}
