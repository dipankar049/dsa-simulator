    ...
    return (
        <div>
            <Helmet>
                ...
                <meta
                    name="description"
                    content="Simulate the bubble sort algorithm swapping adjacent elements step-by-step. Perfect visual aid for learning O(n²) sorting mechanics."
                />
                                        ...
                                        {array.map((item, index) => {
                                            ...
                                            return (
                                                <div
                                                    ...
                                                    className={`cell arrayDiv h-8 w-10 shrink-0 text-xs sm:h-11 sm:w-14 sm:text-base font-semibold animate-fadeIn
